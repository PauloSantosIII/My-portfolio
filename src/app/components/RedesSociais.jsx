...
const RedesSociais = () => {
  ...
  return(
    <div className='text-font-white text-xl fixed bottom-2 z-50 bg-primary left-[10%] w-[80%] h-11 rounded-full flex justify-evenly items-center border sm:border-l-2 sm:top-6 sm:left-[92%] sm:w-[8%] sm:h-60 sm:flex-col sm:gap-3 sm:mx-0 sm:rounded-3xl sm:rounded-r-none md:left-[99%] md:hover:left-[96%] md:w-[4%] last-one' id='home' ref={divSectionRef}>
